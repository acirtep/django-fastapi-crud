    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "first_name",
                    models.CharField(
                        db_comment="the first name of the writer", null=True
                    ),
                ),
                (
                    "last_name",
                    models.CharField(
                        db_comment="the last name of the writer", null=True
                    ),
                ),
                (
                    "email",
                    models.EmailField(
                        db_comment="the email of the writer",
                        max_length=254,
                        unique=True,
                    ),
                ),
                (
                    "about",
                    models.CharField(
                        db_comment="a short intro of the writer", null=True
                    ),
                ),
                (
                    "joined_timestamp",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "writer_country_code",
                    models.CharField(db_comment="the country iso code of the writer"),
                ),
            ],
            options={
